...
namespace FairyGUI
{
	...
	{
		public static int RootComponentCounter = 0;
		public static int RootComponentGcCounter = 0;
		public static List<string> s_gcRootComponentNameList = new List<string>();

		private bool m_isRootComponent = false;
		public void OnRootComponentCreate()
		{
			RootComponentCounter++;
			m_isRootComponent = true;
		}
		// 全局对象计数(调试用)
